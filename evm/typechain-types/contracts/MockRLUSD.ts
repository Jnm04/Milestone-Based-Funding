...
export interface MockRLUSDInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface MockRLUSD extends BaseContract {
  connect(runner?: ContractRunner | null): MockRLUSD;
  waitForDeployment(): Promise<this>;

  interface: MockRLUSDInterface;
