...
const ITEMS = [
  {
    ...
    a: "No one — the smart contract does. Once the Requester funds the milestone, RLUSD is locked in a smart contract on the XRPL EVM Sidechain. Neither the Requester nor Cascrow can withdraw funds arbitrarily. Only the contract logic itself can release them.",
  },
  {
  ...
  },
  {
    ...
    a: "You'll see the AI's detailed reasoning directly on the contract page. You can revise your proof and resubmit — there's no limit on resubmission attempts before the deadline. If you believe the verdict is incorrect, the Requester can also override it manually.",
  },
  {
    q: "Can the Requester cancel after funding?",
    a: "Not before the deadline. Once funds are locked in escrow they stay locked — until either the milestone is verified or the deadline passes. If no proof is submitted in time, the Requester can reclaim the RLUSD automatically.",
  },
  {
