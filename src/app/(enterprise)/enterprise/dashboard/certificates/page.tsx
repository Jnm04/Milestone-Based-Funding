...
export default async function CertificatesPage() {
  ...
  // Fetch all completed milestones across attestation contracts for this user
      ...
      {completedMilestones.length === 0 ? (
        <div style={{ ...s.card, textAlign: "center", padding: "72px 24px" }}>
          ...
          <p style={{ margin: "0 0 24px", fontSize: 13.5, color: "var(--ent-muted)", maxWidth: 400, marginLeft: "auto", marginRight: "auto" }}>
            Certificates are issued when a milestone is verified and completed. Start by creating a goal set and submitting evidence.
          </p>
          <a
              ...
              <div style={{
                ...
                {m.nftImageUrl ? (
                  ...
                  <div style={{ textAlign: "center", padding: 20 }}>
                    <svg width="40" height="40" fill="none" stroke="#93C5FD" strokeWidth={1.25} viewBox="0 0 24 24" style={{ margin: "0 auto 8px" }}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 01-1.043 3.296 3.745 3.745 0 01-3.296 1.043A3.745 3.745 0 0112 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 01-3.296-1.043 3.745 3.745 0 01-1.043-3.296A3.745 3.745 0 013 12c0-1.268.63-2.39 1.593-3.068a3.745 3.745 0 011.043-3.296 3.746 3.746 0 013.296-1.043A3.746 3.746 0 0112 3c1.268 0 2.39.63 3.068 1.593a3.746 3.746 0 013.296 1.043 3.746 3.746 0 011.043 3.296A3.745 3.745 0 0121 12z" />
                    </svg>
                    <p style={{ margin: 0, fontSize: 11.5, color: "#93C5FD", fontWeight: 500 }}>Certificate Pending</p>
                  </div>
                )}
              </div>
              ...
              <div style={{ padding: "18px 20px", flex: 1 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: 12 }}>
                  <div>
                    ...
                    <p style={{ margin: 0, fontSize: 12.5, color: "var(--ent-text)", fontWeight: 500 }}>
                      {new Date(m.cancelAfter).toLocaleDateString("en-GB", { day: "numeric", month: "short", year: "numeric" })}
                    </p>
                  </div>
                  <span style={{
                    display: "inline-flex",
                ...
                {(m.nftTokenId || m.nftTxHash) && (
                  <div style={{
                    ...
                    {m.nftTokenId && (
                      <p style={{ margin: 0, fontSize: 11, color: "var(--ent-muted)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                        <span style={{ fontWeight: 600 }}>Token:</span> {m.nftTokenId}
                      </p>
                    )}
                    {m.nftTxHash && (
                      <a
                        href={`https://xrpscan.com/tx/${m.nftTxHash}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        style={{ fontSize: 11, color: "var(--ent-accent)", textDecoration: "none", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", display: "block" }}
                      >
                        View on XRPL →
                      </a>
                    )}
