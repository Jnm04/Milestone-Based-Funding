    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md flex flex-col items-center gap-6">
        ...
        >
          ...
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#C4704B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="flex flex-col gap-1">
            <h1
              ...
              style={{ fontFamily: "var(--font-libre-franklin), sans-serif", color: "#EDE6DD" }}
            >
              404
            </h1>
            <p className="text-sm uppercase tracking-widest font-medium" style={{ color: "#C4704B" }}>
              Page not found
            </p>
          </div>
