...
> Full plan in **[PLANNING_ENTERPRISE.md](PLANNING_ENTERPRISE.md)**
>
> Status: Planning — not yet started  
> Summary: `Contract.mode = "ESCROW" | "ATTESTATION"` — no escrow, no RLUSD, just data sources + AI verification + blockchain attestation. Targets CSRD/ESG compliance, corporate KPI tracking. Core flow ~5-7 days to build.
